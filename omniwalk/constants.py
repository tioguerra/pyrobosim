# Configuration parameters used by the gait
# generation algorithm.

C1 = 0.02 # Halt Position Leg Extension
C2 = 0.1 # Halt Position Leg Roll Angle
C3 = 0.02 # Halt Position Leg Pitch Angle
C4 = 0.03 # Halt Position Foot Roll Angle
C5 = 0.0 # Halt Position Foot Pitch Angle

C6 = 0.02 # Constant Ground Push
C7 = 0.0 # Proportional Ground Push
C8 = 0.3 # Constant Step Height
C9 = 0.12 # Proportional Step Height

C_tau_0 = 0 # Swing Start Timing
C_tau_1 = 2.3876 # Swing Stop Timing
C10 = 0.17 # Sagittal Swing Amplitude Fwd
...
C17 = 0.035 # Lateral Hip Swing Amplitude
...
C22 = 0.0085 # Sagittal Acceleration
